...
for x in [x0*s for s in [.25,.5,1.,2,4]]:
    plt.plot([r.demands(x,ceteris_paribus_price(my_j,p0))[my_j] for p0 in P],P)
...
plt.plot([np.log(nutrient_adequacy_ratio(poorer_x,ceteris_paribus_price(my_j,p0)))[UseNutrients] for p0 in P],P)
plt.legend(UseNutrients)
plt.ylabel('Price')
